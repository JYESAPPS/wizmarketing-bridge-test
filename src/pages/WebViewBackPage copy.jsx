...
export default function WebViewBackPage({ isRoot = false }) {
    ...
    const { logs, pushLocal, clear } = useSectionLog(
        ["NAV_STATE_ACK", "BACK_REQUEST", "BACK_DEBUG", "PERMISSION_STATUS",
            "SPLASH_STATE", "OFFLINE_FALLBACK", "WEB_READY_ACK", "WEB_ERROR_ACK"],
        200
    );
